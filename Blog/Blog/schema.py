...
class Query(category.schema.Query, user.schema.Query, tag.schema.Query, graphene.ObjectType):
    pass

class Mutation( category.schema.Mutation, user.schema.Mutation, tag.schema.Mutation, graphene.ObjectType):
